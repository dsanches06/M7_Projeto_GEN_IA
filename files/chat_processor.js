...
import {
  functionDeclarations as patchStatusDeclarations,
  setPatchStatusTaskValues,
} from "../../functions/tasks/patch_status_task.js";
 ...
 *
 *   - set_create_task_values          → cria tarefa
 *   - set_assign_task_values          → atribui tarefa existente
 *   - set_tag_task_values             → adiciona etiquetas a tarefa
 *   - set_patch_status_task_values    → muda estado da tarefa
