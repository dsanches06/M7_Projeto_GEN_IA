...
const NotificationButton = ({ user, onToggle }) => {
  ...
  const fetchUnreadCount = async () => {
    ...
    try {
      ...
      const count = Array.isArray(list) ? list.filter(n => !n.isRead && !n.is_read).length : 0;
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius:"50%", transition:"background 0.2s", outline:"none",
      }}
    ...
    >
      <svg viewBox="0 0 64 72" width="26" height="26" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <path d="M32 9 C19 9 11 19 10 30 L7 52 Q6.5 58 12 58 L52 58 Q57.5 58 57 52 L54 30 C53 19 45 9 32 9 Z"
              fill={bellColor} />
      ...
      {!loading && (
        <span style={{
          position:"absolute", top:"-1px", right:"-3px", minWidth:"19px", height:"19px",
          background:"#E53535", color:"#fff", borderRadius:"50%",
          display:"flex", alignItems:"center", justifyContent:"center",
          fontSize:"11px", fontWeight:700, lineHeight:1,
          padding:"0 3px", border:`2px solid ${badgeBorder}`, boxSizing:"border-box",
        }}>
