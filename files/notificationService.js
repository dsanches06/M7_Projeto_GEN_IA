...
/**
 * Dynamic update — only sets the fields provided in `data`.
 * Prevents accidental NULL-ing of message when only is_read is supplied.
 */
export const updateNotification = async (id, data) => {
  ...
  if (data.message  !== undefined) add("message",  data.message);
  if (data.is_read  !== undefined) add("is_read",  data.is_read);
