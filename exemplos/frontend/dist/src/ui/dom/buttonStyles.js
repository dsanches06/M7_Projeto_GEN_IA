 ...
 */
export function styleTransparentButton(btn, color = "#007bff", hoverColor) {
    if (!btn)
        return;
 ...
 */
export function styleSearchInput(input) {
    if (!input)
        return;
 ...
 */
export function styleActionContainer(container) {
    if (!container)
        return;
}
/**
 ...
 */
export function styleCountersContainer(container) {
    if (!container)
        return;
}
