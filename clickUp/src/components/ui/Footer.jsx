...
export function Footer() {
  ...
  return (
    <footer
      className={`border-t border-surface py-4 ${isDark ? "bg-surface" : "bg-surface-2"}`}
    >
      <div className="container mx-auto px-4 text-center text-sm text-muted">
        ...
        <div className="mt-4 flex justify-center gap-4">
          <a
            ...
            className="text-muted hover:text-primary hover:scale-110 transition-all duration-200 cursor-pointer"
          ...
          <a
            href="https://github.com/dsanches06/M7_Projeto_GEN_IA"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted hover:text-primary hover:scale-110 transition-all duration-200 cursor-pointer"
