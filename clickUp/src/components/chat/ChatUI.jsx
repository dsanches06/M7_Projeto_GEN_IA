...
export function ChatUI({ isOpen, onClose, onTaskCreated }) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-y-0 right-0 z-50 flex w-full max-w-md sm:w-[420px] flex-col bg-page border-l border-surface shadow-2xl rounded-tl-3xl rounded-bl-3xl overflow-hidden">
