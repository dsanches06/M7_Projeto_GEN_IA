...
export function createUserCard(user) {
    return __awaiter(this, void 0, void 0, function* () {
        const divUserCard = createSection("sectionUserCard");
        ...
        try {
            ...
            const count = allTasks.filter((task) => {
                var _a, _b;
                const assignees = ((_b = (_a = task).getAssignees) === null || _b === void 0 ? void 0 : _b.call(_a)) || [];
                return assignees.some((a) => a.user_id === user.getId());
            }).length;
        ...
        tasksBtn.addEventListener("click", (event) => __awaiter(this, void 0, void 0, function* () {
            event.stopPropagation();
            try {
        ...
        assignTaskBtn.addEventListener("click", (event) => __awaiter(this, void 0, void 0, function* () {
            event.stopPropagation();
            yield renderTaskAssignModal(user, "assign");
        }));
        ...
        removeAssignTaskBtn.addEventListener("click", (event) => __awaiter(this, void 0, void 0, function* () {
            event.stopPropagation();
            yield renderTaskAssignModal(user, "remove");
        }));
        ...
        toggleBtn.addEventListener("click", (event) => __awaiter(this, void 0, void 0, function* () {
            event.stopPropagation();
            yield toggleUserState(user.getId());
...
function renderTaskAssignModal(user, action) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const userAssignedTaskIds = new Set(allAssignees
            ...
            if (filteredTasks.length === 0) {
                ...
                filteredTasks.forEach((task) => {
                    ...
                    button.addEventListener("click", (e) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            if (action === "remove") {
                                const assignee = allAssignees.find((a) => a.task_id === task.getId() && a.user_id === userId);
                                if (assignee) {
                                    // Use task_id and user_id for deletion if id is not available
                                    const assigneeId = assignee.id || assignee.task_id;
                                    yield TaskAssigneeService.deleteTaskAssignee(assigneeId);
                                    showInfoBanner(`Atribuição da tarefa "${task.getTitle()}" removida.`, "success-banner");
                                }
                            }
                            else if (action === "assign") {
                                yield TaskAssigneeService.createTaskAssignee({
                                    task_id: task.getId(),
                                    user_id: userId,
                                });
                            ...
                            yield loadUserTasksPage(userId);
                        }
                        catch (error) {
