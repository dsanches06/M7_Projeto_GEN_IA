...
export class UsersDashboard {
    constructor(user, tasks = []) {
        ...
        this.container = document.querySelector("#dashBoardContainer") ||
    ...
    loadStatusMap() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const statuses = yield TaskStatusService.getTaskStatuses();
    ...
    render() {
        ...
        backBtn.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield loadUserTasksPage(this.user.getId());
            }
            catch (error) {
    ...
    populateColumns() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const column of this.statusColumns) {
                ...
                const tasksContainer = this.container.querySelector(`.tasks-container[data-status="${column.id}"]`);
                const countBadge = this.container.querySelector(`.column-count[data-status="${column.id}"]`);
                if (tasksContainer && countBadge) {
                    ...
                    for (const task of colTasks) {
                        const card = yield this.createTaskCard(task);
    ...
    createTaskCard(task) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const sprintTasks = yield SprintTaskService.getSprintTasks();
                const sprintTask = sprintTasks.find((st) => st.task_id === task.getId());
                if (sprintTask && sprintTask.sprint_id) {
                    const allSprints = yield SprintService.getSprints();
                    const sprint = allSprints.find((s) => { var _a, _b; return ((_b = (_a = s.getId) === null || _a === void 0 ? void 0 : _a.call(s)) !== null && _b !== void 0 ? _b : s.id) === sprintTask.sprint_id; });
                    if (sprint) {
                        sprintName = ((_c = (_b = (_a = sprint.getName) === null || _a === void 0 ? void 0 : _a.call(sprint)) !== null && _b !== void 0 ? _b : sprint.name) !== null && _c !== void 0 ? _c : "Sprint");
                    }
                }
            }
            catch (error) {
    ...
    attachEventListeners() {
        ...
        this.container.onclick = (event) => {
            ...
            if (task)
                this.renderStatusModal(task);
        };
    }
    renderStatusModal(task) {
      ...
      `;
            ...
            btn.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
                yield this.updateTaskStatus(task.getId(), statusCol.id);
                modal.remove();
            }));
    ...
    updateTaskStatus(taskId, newStatus) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield TaskService.updateTask(taskId, { status_id: this.getStatusId(newStatus) });
    ...
    getStatusId(statusLabel) {
        return this.statusMap[statusLabel] || 1;
    }
    updateTasks(newTasks) {
        return __awaiter(this, void 0, void 0, function* () {
            this.tasks = newTasks;
            yield this.populateColumns(); // Atualiza os cards sem recriar as colunas (melhor performance)
        });
    }
    getContainer() {
        return this.container;
